    ...
    <div class="card-body">
        ...
        <form method="post" role="form" action="{{ route('permohonanUpdate', ['permohonan' => $permohonan->slug]) }}" enctype="multipart/form-data" id="myForm">
            ...
            <div class="form-group row">
                <label for="nama" class="col-md-4 col-form-label text-md-left">{{ __('Nama Permohonan') }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group-row">
                ...
                <div class="form-group d-flex justify-content-end" style="margin-bottom: 50px">
                    <div>
                        ...
                        <span>&nbsp;&nbsp;</span>
                        <a class="btn btn-light border border-dark rounded" href="{{ route('permohonanShow' , ['permohonan' => $permohonan->slug]) }}">{{ __('Kembali') }}</a>
                    </div>
                </div>
            </div>
