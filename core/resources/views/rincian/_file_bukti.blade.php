                ...
                <div class="modal-body text-left p-lg">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <input id="biayaterpakai{{$rincian->id}}" type="text" placeholder="Masukkan Dana Terpakai" class="form-control {{ $errors->has('biayaterpakai') ? ' is-invalid' : '' }}" name="biayaterpakai" value="{{ old('biayaterpakai') }}" required autofocus>
