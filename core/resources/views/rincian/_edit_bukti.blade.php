<!-- .modal -->
    <div id="m-eb{{$rincian->id}}" class="modal fade" data-backdrop="true">
        <div class="modal-dialog" id="animate">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Bukti</h5>
                </div>
            <form method="post" role="form" action="{{ route('editBukti' , ['id' => $rincian->id]) }}" enctype="multipart/form-data" id="myForm{{$rincian->id}}">
                {{ csrf_field() }}
                <div class="modal-body text-left p-lg">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-8">
                          <input type="file" name="file" style="font-size: 15px" class="form-control{{ $errors->has('file') ? ' is-invalid' : '' }}" id="file" value="{{ old('file') }}">
                          @if ($errors->has('file'))
                              <span class="invalid-feedback" role="alert">
