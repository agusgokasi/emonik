<!-- .modal -->
    <div id="m-te-{{ $kegiatan->id }}" class="modal fade" data-backdrop="true">
        <div class="modal-dialog" id="animate">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Konfirmasi Terima Proker</h5>
                </div>
            <form method="post" role="form" action="{{ route('prokerTerima',["id"=>$kegiatan->id]) }}" enctype="multipart/form-data" id="myForm{{ $kegiatan->id }}">
                {{ csrf_field() }}
